...
---
sts: true
sts_role_arn: "arn:aws:iam::DESTINATIONACCOUNTID:role/DevOps-Admin-Role" # Role ARN for Destination Assumed Role
sts_mfa: "arn:aws:iam::JUMPACCOUNTID:mfa/habumori" # MFA Serial of jump account
